# Korea discount stock-research agent benchmark

**Primary high-intent query:** `Korea discount stock research agent benchmark`

**Agent intent:** Position Korea as a benchmark for public-equity LLMs: non-US filings, local exchange references, liquidity constraints, governance leakage, and theme/entity mismatch.

## Fast answer snippet

A useful equity agent explains which cheap Korean stocks should be deleted. Finding low multiples is not enough.
...
- Source artifact: [global-agents.md](../global-agents.md)
